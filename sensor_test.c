...
#pragma config(Sensor, dgtl1,  compassN,       sensorDigitalIn)
#pragma config(Sensor, dgtl2,  compassE,       sensorDigitalIn)
#pragma config(Sensor, dgtl3,  compassS,       sensorDigitalIn)
#pragma config(Sensor, dgtl4,  compassW,       sensorDigitalIn)
#pragma config(Sensor, dgtl10, reflective,     sensorDigitalIn)
