...
int get_distanceL()
{
	...
	for (int i = 0; i < numberOfReadingsToAverage; i++)
	{
        ...
        if ((0<distanceL)&&(distanceL<40))
        {
            curr_wt = 1;
        }
        else if ((40<=distanceL)&&(distanceL<=50))
        {
            curr_wt = 0.8;
        }
        else if((50<distanceL)&&(distanceL<60))
        {
            curr_wt = 0.6;
        }
        else if ((60<=distanceL)&&(distanceL<=70))
        {
            curr_wt = 0.4;
        }
        else if((70<distanceL)&&(distanceL<=75))
        {
            curr_wt = 0.1;
        }
		totalL = totalL + curr_wt;
	}
...
int get_distanceR()
{
	...
	for (int i = 0; i < numberOfReadingsToAverage; i++)
	{
        ...
        if ((0<distanceR)&&(distanceR<40))
        {
            curr_wt = 1;
        }
        else if ((40<=distanceR)&&(distanceR<=50))
        {
            curr_wt = 0.8;
        }
        else if((50<distanceR)&&(distanceR<60))
        {
            curr_wt = 0.6;
        }
        else if ((60<=distanceR)&&(distanceR<=70))
        {
            curr_wt = 0.4;
        }
        else if((70<distanceR)&&(distanceR<=75))
        {
            curr_wt = 0.1;
        }
		totalR = totalR + curr_wt;
	}
	if(totalR>10)
    {
        return 1;
...
int get_distanceTL()
{
	...
	for (int i = 0; i < numberOfReadingsToAverage; i++)
	{
		...
		else if (distanceTL > 80)
		{
			distanceTL = 80;
		}
        if ((0<distanceTL)&&(distanceTL<40))
        {
            curr_wt = 1;
        }
        else if ((40<=distanceTL)&&(distanceTL<=50))
        {
            curr_wt = 0.8;
        }
        else if((50<distanceTL)&&(distanceTL<60))
        {
            curr_wt = 0.6;
        }
        else if ((60<=distanceTL)&&(distanceTL<=70))
        {
            curr_wt = 0.4;
        }
        else if((70<distanceTL)&&(distanceTL<=75))
        {
            curr_wt = 0.1;
        }
		totalTL = totalTL + curr_wt;
	}
	if(totalTL>10)
    {
        return 1;
...
int sensorDetect()
{
	...
	returnVal = (returnVal+(100*avgL)+(10*avgTL)+(avgR));
	return returnVal;
}
