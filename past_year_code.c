...
void motion_move_backward(int time)
{
// 45,50 (33,40)
clearTimer(T2);
//timer=time1[T2];
...
void motion_move_backward_fast(int time)
{
// 45,50 (33,40)
clearTimer(T2);
//timer=time1[T2];
...
void motion_turn_left(int time)
{
// 45,50 (33,40)
clearTimer(T2);
//timer=time1[T2];
...
// Turn left on the spot
void motion_turn_left_fast(int time)
{
// 45,50 (33,40)
clearTimer(T2);
//timer=time1[T2];
...
void motion_turn_right(int time)
{
